...
const routes = [
  {
    ...
    children:[
      ...
      {path:'/board-of-directors',name:'BoardOfDirectors',component:BoardOfDirector},
      {path:'/member-registration',name:'MemberRegistration',component:MemberRegistration},
      {path:'/member-address',name:'MemberAddress',component:MemberAddress},
      {path:'/member-payment-history',name:'MemberPaymentHistory',component:PaymentHistory},
      {path:'/member-documents',name:'MemberDocuments',component:MemberDocuments},
      ...
      {path:'/preview/announcement-template',name:"AnnouncementTemplate",component:AnnouncementTemplate},
      ...
      {path:'/create-message-template',name:'MessageTemplate',component:Template},
      {path:'/autogate',name:'Autogate',component:Autogate},
      {path:'/create-autogate-template',name:'AutogateTemplate',component:AutogateTemplate},
      {path:'/billing',name:'Billing',component:Billing},
      {path:'/privilege/management',name:'PrivilegeManagement',component:PrivilegeManagement},
