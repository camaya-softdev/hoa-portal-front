        ...
        <div class="w-full min-h-screen">
          ...
          <div class="mt-3 text-center">
            <p class="inline-flex items-center justify-center py-2 px-4 text-sm">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="stroke-yellow-600 w-6 h-6">
                <path stroke-linecap="round" stroke-linejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
              </svg>
              <span class="ml-1">{{ user.data.email }}</span>
              <span>
                  <a class="ml-3 group inline-flex items-center justify-center rounded-full py-2 px-4 text-sm focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 bg-yellow-600 text-white hover:bg-yellow-600 hover:text-white active:bg-yellow-600 active:text-slate-300 focus-visible:outline-slate-900 transform transition duration-500 hover:scale-105" href="#" @click="changePassword = true">
          ...
          <div class="flex flex-wrap justify-center">
            ...
            <div class="lg:mx-48 sm:mx-auto">
              <ul role="list" class="mt-5 mx-auto grid max-w-2xl grid-cols-1 gap-6 sm:gap-8 lg:mt-20 lg:max-w-none lg:grid-cols-4 text-center align-items-center">
                    ...
                    <li>
                        <figure class="relative rounded-2xl bg-white p-6 shadow-xl shadow-slate-900/10">
                            <blockquote class="relative">
                              <p class="text-center text-4xl font-medium leading-none tracking-tight text-yellow-600">{{ data.user }}</p> 
                            </blockquote>
                            <figcaption class="relative mt-6 flex items-center justify-between border-t border-slate-100 pt-6">
                              <div>
                                <div class="font-display text-sm text-slate-900">Total Number of HOA Members</div>
                              </div>
                            </figcaption>
                          </figure>
                      </li>
                ...
                <li>
                  <ul role="list" class="flex flex-col gap-y-6 sm:gap-y-8 transform transition duration-500 hover:scale-105">
                    <li>
                        <figure class="relative rounded-2xl bg-white p-6 shadow-xl shadow-slate-900/10">
                            <blockquote class="relative">
                              <p class="text-center text-4xl font-medium leading-none tracking-tight text-yellow-600">{{ data.userPerMonth }}</p> 
                            </blockquote>
                            <figcaption class="relative mt-6 flex items-center justify-between border-t border-slate-100 pt-6">
                              <div>
                                <div class="font-display text-sm text-slate-900">Total Number of New Members ({{ data.month }})</div>
                              </div>
                            </figcaption>
                          </figure>
                      </li>
                ...
                <li>
                  <ul role="list" class="flex flex-col gap-y-6 sm:gap-y-8 transform transition duration-500 hover:scale-105">
                    <li>
                        <figure class="relative rounded-2xl bg-white p-6 shadow-xl shadow-slate-900/10">
                            <blockquote class="relative">
                              <p class="text-center text-4xl font-medium leading-none tracking-tight text-yellow-600">{{ data.card }}</p>
                            </blockquote>
                            <figcaption class="relative mt-6 flex items-center justify-between border-t border-slate-100 pt-6">
                              <div>
                                <div class="font-display text-sm text-slate-900">Total Number of RFID Card Holders</div>
                              </div>
                            </figcaption>
                          </figure>
                      </li>
                ...
                <li>
                  <ul role="list" class="flex flex-col gap-y-6 sm:gap-y-8 transform transition duration-500 hover:scale-105">
                    <li>
                        <figure class="relative rounded-2xl bg-white p-6 shadow-xl shadow-slate-900/10">
                            <blockquote class="relative">
                              <p class="text-center text-4xl font-medium leading-none tracking-tight text-yellow-600">{{ data.billing }}</p>
                            </blockquote>
                            <figcaption class="relative mt-6 flex items-center justify-between border-t border-slate-100 pt-6">
                              <div>
                                <div class="font-display text-sm text-slate-900">Member Payments for Verification</div>
                              </div>
                            </figcaption>
                          </figure>
                      </li>
