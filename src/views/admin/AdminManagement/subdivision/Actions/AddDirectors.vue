    ...
    <form>
      <div class="mb-4">
        ...
        <el-select
          ...
          v-model="form.user_id" filterable  placeholder="Full Name">
          <el-option
      ...
      <div class="mb-4">
        ...
        <el-select
          class="shadow appearance-none border-gray-300 rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
          v-model="form.hoa_access_type" filterable placeholder="HOA Access Type">
          <el-option
      ...
      <div class="mb-4">
        ...
        <textarea
          ...
          :class="
            errorMsg['hoa_bod_desc'] ? 'border-red-300' : 'border-gray-300'
          "
      ...
      <div class="mb-4">
        ...
        <input
          ...
          :class="
            errorMsg['hoa_bod_position'] ? 'border-red-300' : 'border-gray-300'
          "
      ...
      <div>
        ...
        <div class="mt-1 flex items-center">
          <img
            ...
            :src="form.image_url"
            :class="
            errorMsg['image'] ? 'border-red-300' : 'border-gray-300'
          "
            :alt="form.hoa_sales_agent_lname + ' '+form.hoa_sales_agent_fname"
          ...
          <p class="text-gray-500 text-[10px]">The width should be 300 px and height 300 px files with less than 2mb each </p>
      </div>
...
function closeModal() {
  ...
  form.value.hoa_bod_desc= ""
  form.value.hoa_bod_position = ""
  ...
  try {
    if (res.status === 200 || res.status === 201) {
      ...
      await store.commit("alert/notify", {
        title: "Success",
        type: "success",
        message: "The board of director data was successfully created",
      });
      closeModal();
    } else {
