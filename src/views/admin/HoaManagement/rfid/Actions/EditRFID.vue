    ...
    <form v-else>
      ...
      <div class="mb-4">
        ...
        <input
          ...
          :class="errorMsg['hoa_rfid_semnox_num'] ? 'border-red-300' : 'border-gray-300'"
      ...
      <div class="mb-4">
        ...
        <select
          ...
          :class="errorMsg['hoa_rfid_reg_status'] ? 'border-red-300' : 'border-gray-300'"
...
const rfidLoading = computed(() => store.state.rfid.currentRFID.loading);
