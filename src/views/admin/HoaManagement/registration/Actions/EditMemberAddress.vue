    ...
    <div v-else>
      ...
      <form>
        ...
        <div class="mb-4">
          ...
          >
            Does he live here now <span class="text-red-300">*</span>
          </label>
          <el-checkbox
            value="1"
...
<script lang="ts" setup>
  ...
  const selectedOptions = computed(()=>contactNumber.value !== undefined ? contactNumber.value.hoa_sales_agent_contact_number : '')
  watch(
