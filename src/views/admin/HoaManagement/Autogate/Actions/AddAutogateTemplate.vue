    ...
    <form>
      ...
      <div class="mb-4">
        ...
        <div class="mt-1 flex items-center">
          <img
            ...
            :src="form.image_url"
            :class="
            errorMsg['hoa_autogate_template_picture'] ? 'border-red-300' : 'border-gray-300'
          "
      ...
      <div class="mb-4">
        ...
        <input
          ...
          :class="
            errorMsg['hoa_autogate_template_footer'] ? 'border-red-300' : 'border-gray-300'
          "
       ...
       <div class="mb-4">
        ...
        <el-select
          class="shadow appearance-none border-gray-300 rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
          v-model="background" filterable  placeholder="HOA Autogate Member Name"
      ...
      <div class="mb-4">
        <label
          ...
          class="block text-gray-700 text-sm font-bold mb-2">
          HOA Autogate Template Footer Second Page <span class="text-red-300">*</span>
        </label>
      ...
      <div class="mb-4">
        ...
        <input
          ...
          :class="
            errorMsg['hoa_autogate_template_third_page'] ? 'border-red-300' : 'border-gray-300'
          "
      ...
      <div class="mb-4">
        ...
        >
          HOA Autogate Template Footer Third Page <span class="text-red-300">*</span>
        </label>
        <input
          class="shadow appearance-none border-gray-300 rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
          ...
          :class="
            errorMsg['hoa_autogate_template_footer_third_page'] ? 'border-red-300' : 'border-gray-300'
          "
...
function onChange(event){
  if(event){
    return data.value =  props.backgroundData.find(background => background.id === event);
  }
}
  ...
  async function handleSubmit() {
    ...
    form.value.hoa_autogate_template_second_page = JSON.stringify(form.value.hoa_autogate_template_second_page);
    form.value.hoa_autogate_template_footer_second_page = JSON.stringify(form.value.hoa_autogate_template_footer_second_page);
