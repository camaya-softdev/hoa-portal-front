      ...
      <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
        <div class="col-span-6 sm:col-span-6">
          ...
          <input
            ...
            :class="
              errorMsg['bank_name'] ? 'border-red-300' : 'border-gray-300'
            "
            id="bank-name"
        ...
        <div class="col-span-6 sm:col-span-6">
          ...
          <input
            ...
            :class="
              errorMsg['amount_paid'] ? 'border-red-300' : 'border-gray-300'
            "
        ...
        <div class="col-span-6 sm:col-span-6">
          ...
          <input
            ...
            id="date-paid"
            :class="
              errorMsg['date_paid'] ? 'border-red-300' : 'border-gray-300'
            "
        ...
        <div>
          ...
          <el-upload
            ...
            :multiple="true"
            :class="
              errorMsg['filenames'] ? 'border-red-300' : 'border-gray-300'
            "
