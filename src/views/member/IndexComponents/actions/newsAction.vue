<template>
  ...
  >
    ...
    <div v-else class="bg-white">
      <div>
        <h2 class="text-2xl text-center font-extrabold tracking-tight text-gray-900">
          {{ newsData.title }}
        </h2>

        <div class="mt-6 content-center">
          <div
            class="w-full min-h-80 bg-gray-200 aspect-w-2 aspect-h-2 rounded-md overflow-hidden group-hover:opacity-75 lg:h-80 lg:aspect-none"
          >
            <img
              :src="newsData.photo"
              :alt="newsData.title"
