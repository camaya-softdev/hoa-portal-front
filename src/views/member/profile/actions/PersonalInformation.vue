              ...
              <div class="grid grid-cols-6 gap-6">
                ...
                <div class="col-span-6 sm:col-span-3">
                  ...
                  <input
                    ...
                    :class="
                          errorMsg['email'] ? 'border-red-300' : 'border-gray-300'
                          "
                    class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                  />
                  <span
                ...
                <div class="col-span-6 sm:col-span-3">
                  ...
                  <input
                    ...
                    :class="
                          errorMsg['hoa_member_phone_num'] ? 'border-red-300' : 'border-gray-300'
                          "
...
<script setup>
  ...
  watch(() => store.state.information.information.data,
    (newVal, oldVal) => {
