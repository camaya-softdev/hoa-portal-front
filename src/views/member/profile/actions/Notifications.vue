                  ...
                  <div class="flex items-start">
                    ...
                    <div class="ml-3 text-sm">
                      <label for="comments" class="font-medium text-gray-700"
                        >Announcement</label
                      >
                      <p class="text-gray-500">Get notified on a Latest Announcement.</p>
                    </div>
                  </div>
                  <div class="flex items-start">
                    <div class="flex items-center h-5">
                    ...
                    <div class="ml-3 text-sm">
                      <label for="candidates" class="font-medium text-gray-700"
                        >News</label
                      >
                      <p class="text-gray-500">Get notified on a Latest News.</p>
                    </div>
                  </div>
                  <div class="flex items-start">
                    <div class="flex items-center h-5">
                    ...
                    <div class="ml-3 text-sm">
                      <label for="offers" class="font-medium text-gray-700"
                        >E-Billing</label
                      >
                      <p class="text-gray-500">Get notified when Latest Billing.</p>
                    </div>
                  </div>
                </div>
              </fieldset>
...
watch(
  () => store.state.notification.notification.data,
  (newVal, oldVal) => {
